...
use Icinga\Module\Eventtracker\Web\Form\Action\IetFormExtension;
...
class IetAction extends SimpleTaskConstructor implements Action
{
    ...
    {
        return new IetFormExtension();
    }

    public static function getLabel()
    {
        return StaticTranslator::get()->translate('iET API Action');
    }

    public static function getDescription()
    {
        return StaticTranslator::get()->translate(
            'Send a API request to iET, based on a specific implementation'
        );
    }
