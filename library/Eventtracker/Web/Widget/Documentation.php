...
class Documentation
{
    ...
    public function getModuleLink($label, $module, $chapter, $title = null)
    {
        ...
        if ($this->hasAccessToDocumentationModule()) {
            return Link::create(
                $label,
                $this->getModuleDocumentationUrl($chapter),
                null,
    ...
    protected function getModuleDocumentationUrl($chapter)
    {
        return 'doc/module/eventtracker/chapter/'
    ...
    {
        return sprintf(
            "https://github.com/Thomas-Gelf/icingaweb2-module-%s/blob/master/doc/%s.md",
            \rawurlencode($module),
